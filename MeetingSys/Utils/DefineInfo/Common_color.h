...
#define kSplitLineColor      kColorSeparatorline5


//文字颜色
#define kFontBlackColor      UIColorHex(0x333333)
#define kFontGrayColor       UIColorHex(0x999999)
#define kFontBlueColor       UIColorHex(0x02b0f0)
#define kFontDarkgrayColor   kColorDarkgray

/// 导航栏背景颜色
#define kColorNavBground [UIColor whiteColor]//kMainColor
